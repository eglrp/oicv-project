...
for i=iters
    ...
    [seg, c1, c2]=G8_ChanVeseIpol_GDExp( I, phi_0, mu, nu, eta, lambda1, lambda2, tol, epHeaviside, dt, iterMax, reIni, fname, plot_iters);
    
    I(seg>=0)=c1;
    I(seg<0)=c2;

    imwrite(I, strcat('code\result_',fname(1:end-3),'png'))
end
